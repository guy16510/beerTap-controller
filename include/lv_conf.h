...
/*—————————————————————————————————————————————————————————*/
/* Double-buffer a small strip (your foam region) to eliminate tearing */
/* Foam strip is 480px wide × 20px tall, so 480*20 pixels */
#define LV_VDB_SIZE        (480 * 20)
/* Use two of these buffers so LVGL can render one while flushing the other */
#define LV_VDB_PX_DOUBLE   1
/*————————————————————————————
...
#define LV_DISP_DEF_REFR_PERIOD 16     /*[ms]*/ //60hz
